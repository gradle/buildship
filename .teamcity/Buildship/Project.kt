...
val individualBuildsForPhase1 = listOf(
    IndividualScenarioBuildType(ScenarioType.SANITY_CHECK, OS.LINUX, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21)
)
val individualBuildsForPhase2 = listOf(
    // Last Eclipse version supporting Java 8
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_8, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_8, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    // Last Eclipse version supporting Java 17
    ...
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21),
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21)
)
val individualBuildsForPhase3 = listOf(
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_8, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_9, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_10, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_11, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_12, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_13, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_14, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_15, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_16, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    ...
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_28, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_29, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_30, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_31, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_32, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_33, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    ...
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21),

    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_8, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    ...
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21)
)
val individualBuildsForPhase4 = listOf(
    IndividualScenarioBuildType(ScenarioType.CROSS_VERSION, OS.LINUX, EclipseVersion.ECLIPSE4_8, eclipseRuntimeJdk = Jdk.OPEN_JDK_8),
    ...
    IndividualScenarioBuildType(ScenarioType.CROSS_VERSION, OS.LINUX, EclipseVersion.ECLIPSE4_41, eclipseRuntimeJdk = Jdk.OPEN_JDK_21)
)
    ...
    steps {
        gradle {
            ...
            gradleParams = "-Platest=${if(eclipseVersion.isLatest) "true" else "false"} " +
                    ...
                    "-Peclipse.version=%eclipse.version% " +
                    "-Pbuild.invoker=%build.invoker% " +
                    "-Prelease.type=%eclipse.release.type% " +
                    "-Peclipse.test.java.version=%eclipse.test.java.version% " +
                    "--info " +
                    "--stacktrace " +
...
class PromotionBuildType(promotionName: String, typeName: String, dependency: BuildType, trigger: Trigger = Trigger.NONE, upstreamBuilds: List<BuildType> = listOf()) : BuildType({
    ...
    params {
        when(typeName) {
            "milestone" -> text("Confirm", "NO",
                label = "Do you want to proceed with the milestone?",
...
object Project : Project({
    ...
    params {
        ...
        password("eclipse.downloadServer.password", "credentialsJSON:33ba8b1f-d307-431e-9012-81c4066bf302", label = "Password", display = ParameterDisplay.HIDDEN)
