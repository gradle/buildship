...
val individualBuildsForPhase1 = listOf(
    IndividualScenarioBuildType(ScenarioType.SANITY_CHECK, OS.LINUX, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.ORACLE_JDK_8)
)
val individualBuildsForPhase2 = listOf(
    ...
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    ...
    IndividualScenarioBuildType(ScenarioType.BASIC_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.OPEN_JDK_17)
)
val individualBuildsForPhase3 = listOf(
    ...
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_35, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_36, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.LINUX, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.OPEN_JDK_17),
    ...
    IndividualScenarioBuildType(ScenarioType.FULL_COVERAGE, OS.WINDOWS, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.OPEN_JDK_17)
)
val individualBuildsForPhase4 = listOf(
    ...
    IndividualScenarioBuildType(ScenarioType.CROSS_VERSION, OS.LINUX, EclipseVersion.ECLIPSE4_37, eclipseRuntimeJdk = Jdk.OPEN_JDK_17)
)
